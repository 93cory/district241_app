...
class Settings:
    ...
    rate_limit_window_seconds: int = int(os.getenv("PNPI_RATE_LIMIT_WINDOW_SECONDS", os.getenv("PNPI_RATE_LIMIT_WINDOW_SECONDS", "60")))
    auth_rate_limit_max: int = int(os.getenv("PNPI_AUTH_RATE_LIMIT_MAX_REQUESTS", os.getenv("PNPI_AUTH_RATE_LIMIT_MAX_REQUESTS", "15")))
    sensitive_rate_limit_max: int = int(os.getenv("PNPI_SENSITIVE_RATE_LIMIT_MAX_REQUESTS", os.getenv("PNPI_SENSITIVE_RATE_LIMIT_MAX_REQUESTS", "60")))
    ...
    cors_origins: str = os.getenv("PNPI_CORS_ALLOW_ORIGINS", os.getenv("PNPI_CORS_ALLOW_ORIGINS", "http://localhost:3000")).strip()
    ...
    def __init__(self) -> None:
        ...
        self.rate_limit_window_seconds = int(os.getenv("PNPI_RATE_LIMIT_WINDOW_SECONDS", os.getenv("PNPI_RATE_LIMIT_WINDOW_SECONDS", "60")))
        self.auth_rate_limit_max = int(os.getenv("PNPI_AUTH_RATE_LIMIT_MAX_REQUESTS", os.getenv("PNPI_AUTH_RATE_LIMIT_MAX_REQUESTS", "15")))
        self.sensitive_rate_limit_max = int(os.getenv("PNPI_SENSITIVE_RATE_LIMIT_MAX_REQUESTS", os.getenv("PNPI_SENSITIVE_RATE_LIMIT_MAX_REQUESTS", "60")))
        ...
        self.cors_origins = os.getenv("PNPI_CORS_ALLOW_ORIGINS", os.getenv("PNPI_CORS_ALLOW_ORIGINS", "http://localhost:3000")).strip()
