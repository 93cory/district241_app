...
class Settings:
    ...
    cors_origins: str = os.getenv("PNPI_CORS_ALLOW_ORIGINS", os.getenv("PNPI_CORS_ALLOW_ORIGINS", "*")).strip()
    ...
    def __init__(self) -> None:
        ...
        self.cors_origins = os.getenv("PNPI_CORS_ALLOW_ORIGINS", os.getenv("PNPI_CORS_ALLOW_ORIGINS", "*")).strip()
