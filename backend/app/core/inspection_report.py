...
def generate_inspection_report(
    ...
    story.append(
        Paragraph(
            ...
            ParagraphStyle("min", parent=center, fontSize=10, textColor=BLEU, fontName="Helvetica-Bold"),
        )
    )
    ...
    story.append(
        Paragraph(
            ...
            ParagraphStyle(
                "title", parent=center, fontSize=18, textColor=BLEU, fontName="Helvetica-Bold", spaceAfter=4
            ),
        )
    )
    story.append(
        Paragraph(
            f"N\u00b0 {numero_inspection}",
            ParagraphStyle("num", parent=center, fontSize=14, textColor=BLEU, spaceAfter=12),
        )
    )
    ...
    if score_conformite is not None:
        ...
        story.append(
            Paragraph(
                f"Score de conformite : <b>{score_conformite:.0f}%</b>",
                ParagraphStyle("score", parent=center, fontSize=11, textColor=color),
            )
        )
    ...
    # Observations
    story.append(
        Paragraph("<b>Observations :</b>", ParagraphStyle("h3", parent=body, textColor=BLEU, fontSize=12, spaceAfter=6))
    )
    ...
    if recommandations:
        story.append(
            Paragraph(
                "<b>Recommandations :</b>",
                ParagraphStyle("h3r", parent=body, textColor=BLEU, fontSize=12, spaceAfter=6),
            )
        )
    ...
    if photos:
        story.append(
            Paragraph(
                f"<b>Pieces jointes :</b> {len(photos)} photo(s) d'inspection",
                ParagraphStyle("photos", parent=body, textColor=BLEU, fontSize=11),
            )
        )
        story.append(Spacer(1, 0.4 * cm))
