...
def generate_ati_certificate(
    ...
    # Header
    story.append(
        Paragraph("REPUBLIQUE GABONAISE", ParagraphStyle("rg", parent=center_style, fontSize=11, textColor=colors.gray))
    )
    story.append(
        Paragraph(
            "Union · Travail · Justice",
            ParagraphStyle(
                "motto", parent=center_style, fontSize=9, textColor=colors.gray, fontName="Helvetica-Oblique"
            ),
        )
    )
    ...
    story.append(
        Paragraph(
            ...
            ParagraphStyle("ministry", parent=center_style, fontSize=10, textColor=BLEU, fontName="Helvetica-Bold"),
        )
    )
    story.append(
        Paragraph(
            "Direction Generale de l'Industrie", ParagraphStyle("dgi", parent=center_style, fontSize=9, textColor=BLEU)
        )
    )
    ...
    story.append(
        Paragraph(
            "AGREMENT TECHNIQUE INDUSTRIEL",
            ParagraphStyle(
                "title", parent=center_style, fontSize=20, textColor=BLEU, fontName="Helvetica-Bold", spaceAfter=4
            ),
        )
    )
    story.append(
        Paragraph(
            ...
            ParagraphStyle(
                "subtitle", parent=center_style, fontSize=14, textColor=VERT, fontName="Helvetica-Bold", spaceAfter=12
            ),
        )
    )
    story.append(Spacer(1, 0.4 * cm))
    ...
    story.append(
        Paragraph(
            f"N° <b>{numero_ati}</b>",
            ParagraphStyle("num", parent=center_style, fontSize=16, textColor=BLEU, spaceAfter=8),
        )
    )
    if reference_decision:
        story.append(
            Paragraph(
                f"Reference decision : {reference_decision}",
                ParagraphStyle("ref", parent=center_style, fontSize=9, textColor=colors.gray, spaceAfter=12),
            )
        )
    story.append(Spacer(1, 0.6 * cm))
    ...
    story.append(
        Paragraph(
            ...
            ParagraphStyle(
                "signatory", parent=center_style, fontSize=10, textColor=BLEU, fontName="Helvetica-Bold", spaceBefore=8
            ),
        )
    )
