                ...
                >
                  <span
                    style={{
                      ...
                      fontWeight: 700,
                      background:
                        v.version === vers[0].version ? "#dcfce7" : "var(--bg-base, #f4f8fb)",
                  ...
                  {v.comment && (
                    <span style={{ fontStyle: "italic", color: "var(--text-soft, #9ca3af)" }}>
                      &quot;{v.comment}&quot;
                    </span>
                  )}
                  {v.file_size && (
                    <span style={{ color: "var(--text-soft, #9ca3af)" }}>
                      {Math.round(v.file_size / 1024)}KB
                    </span>
                  )}
                  <span
                    style={{ marginLeft: "auto", color: "var(--text-soft, #9ca3af)", fontSize: 10 }}
                  >
