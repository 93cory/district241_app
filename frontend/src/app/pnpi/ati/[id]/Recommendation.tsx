...
const REC_STYLES: Record<string, { color: string; bg: string; icon: string; label: string }> = {
  approuver: {
    ...
    bg: "#dcfce7",
    icon: "\u2713",
    label: "Recommandation : APPROUVER",
  },
  ...
  examen_approfondi: {
    ...
    bg: "#fef3c7",
    icon: "\uD83D\uDD0D",
    label: "Recommandation : EXAMEN APPROFONDI",
  },
          ...
          return (
            <div
              style={{
                ...
                borderRadius: 14,
                background: style.bg,
                border: `2px solid ${style.color}25`,
              }}
            >
              <div
                style={{
              ...
              >
                ...
                <span style={{ fontSize: 20, fontWeight: 800, color: style.color }}>
                  {data.confidence}%
                </span>
              </div>
              <p style={{ fontSize: 13, color: "var(--text-main)", margin: "0 0 10px" }}>
                {data.reason}
              </p>
              ...
              >
                <span style={{ color: "#006233", fontWeight: 700 }}>
                  Approuver {data.approve_pct}%
                </span>
                <span style={{ color: "#b42318", fontWeight: 700 }}>
                  Rejeter {data.reject_pct}%
                </span>
              </div>
              ...
              {data.warnings.length > 0 && (
                <div style={{ marginBottom: 10 }}>
                  ...
                  {data.warnings.map((w, i) => (
                    <div key={i} style={{ fontSize: 12, color: "#d97706", paddingLeft: 8 }}>
                      \u26A0 {w}
                    </div>
                  ))}
                </div>
                ...
                <div>
                  ...
                  {data.similar_cases.map((c, i) => (
                    ...
                    >
                      ...
                      <span
                        style={{
                          color: c.statut === "approuve" ? "#006233" : "#b42318",
                          fontWeight: 700,
                        }}
                      >
                        {c.statut}
              ...
              >
                Cette recommandation est indicative et basee sur l&apos;analyse statistique des
                decisions passees. La decision finale reste a la discretion de l&apos;instructeur.
              </div>
            </div>
          );
        })()}
