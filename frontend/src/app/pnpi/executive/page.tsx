      ...
      >
        {[
          ...
          >
            ...
            <div style={{ fontSize: 10, fontWeight: 600, color: "var(--text-soft, #526175)" }}>
              {k.label}
            </div>
          </div>
        ))}
        ...
        <div className="chart-card" style={{ padding: 20 }}>
          ...
          {predictions.approval_rate ? (
            <div style={{ display: "flex", gap: 16, alignItems: "baseline" }}>
              ...
              >
                {predictions.approval_rate.trend === "hausse" ? "\u2191" : "\u2193"}{" "}
                {predictions.approval_rate.trend}
              </span>
            </div>
          ) : (
          ...
          <div style={{ display: "flex", gap: 12 }}>
            {predictions.forecasts.map((f: any) => (
              ...
              >
                ...
                <div style={{ fontSize: 24, fontWeight: 800, color: "#0c7eb4" }}>
                  {f.predicted_submissions}
                </div>
                <div style={{ fontSize: 9, color: "var(--text-soft, #9ca3af)" }}>
                  {"\u00B1"}
                  {100 - f.confidence}%
                </div>
              </div>
