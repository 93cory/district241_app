          ...
          return (
            <div key={s.stage} className="chart-card" style={{ padding: "16px 20px" }}>
                ...
                <div style={{ textAlign: "center" }}>
                  <div
                    style={{
                      fontSize: 18,
                      fontWeight: 700,
                      color: s.p90_days > 15 ? "#b42318" : "var(--text-main)",
                    }}
                  >
                    {s.p90_days}j
                  </div>
              ...
              >
                <div
                  style={{
                    width: `${(s.median_days / maxDays) * 100}%`,
                    background: color,
                ...
                <div
                  style={{
                    width: `${((s.avg_days - s.median_days) / maxDays) * 100}%`,
                    background: `${color}80`,
                  }}
                  title="Moyenne"
                />
                <div
                  style={{
                    width: `${((s.p90_days - s.avg_days) / maxDays) * 100}%`,
                    background: `${color}40`,
                  }}
                  title="P90"
                />
