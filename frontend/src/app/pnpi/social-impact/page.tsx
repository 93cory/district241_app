    ...
    <div style={{ padding: "24px 32px", maxWidth: 900, margin: "0 auto" }}>
      ...
      >
        {[
          {
            label: "Emplois total",
            value: (data.emplois_total ?? 0).toLocaleString("fr-FR"),
            color: "#006233",
            icon: "\u{1F477}",
          },
          {
            label: "Emplois femmes",
            value: `${(data.emplois_femmes ?? 0).toLocaleString("fr-FR")} (${data.pct_femmes ?? 0}%)`,
            color: "#ec4899",
            icon: "\u{1F469}",
          },
          {
            label: "Emplois jeunes",
            value: `${(data.emplois_jeunes ?? 0).toLocaleString("fr-FR")} (${data.pct_jeunes ?? 0}%)`,
            color: "#0c7eb4",
            icon: "\u{1F9D1}",
          },
          {
            label: "Provinces couvertes",
            value: `${data.provinces_couvertes ?? 0}/9`,
            color: "#7c3aed",
            icon: "\u{1F5FA}\uFE0F",
          },
        ].map((k) => (
          ...
          <div style={{ position: "relative", width: 100, height: 100, margin: "0 auto" }}>
            <svg viewBox="0 0 36 36" style={{ transform: "rotate(-90deg)" }}>
              ...
              <path
                ...
                stroke="#ec4899"
                strokeWidth="3"
                strokeDasharray={`${data.pct_femmes}, 100`}
              />
            </svg>
            <div
              style={{
          ...
          <div style={{ position: "relative", width: 100, height: 100, margin: "0 auto" }}>
            <svg viewBox="0 0 36 36" style={{ transform: "rotate(-90deg)" }}>
              ...
              <path
                ...
                stroke="#0c7eb4"
                strokeWidth="3"
                strokeDasharray={`${data.pct_jeunes}, 100`}
              />
            </svg>
            <div
              style={{
              ...
              <div style={{ flex: 1, height: 10, borderRadius: 5, background: "var(--line)" }}>
                <div
                  style={{
                    ...
                    borderRadius: 5,
                    background: "#006233",
                    width: `${(p.emplois / max) * 100}%`,
                  }}
                />
              </div>
              <span style={{ fontSize: 12, fontWeight: 700, minWidth: 50, textAlign: "right" }}>
                {p.emplois}
              </span>
            </div>
          );
