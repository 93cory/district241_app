        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          {data.funnel.map((step: any, i: number) => (
            <div key={step.stage} style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <span style={{ width: 50, textAlign: "right", fontSize: 12, fontWeight: 700 }}>
                {step.pct}%
              </span>
            </div>
          ))}
              ...
              return (
                <div key={b.bucket} style={{ flex: 1, textAlign: "center" }}>
                  ...
                  <div
                    style={{
                      height: h,
                      background: isLong ? "#b42318" : "#0c7eb4",
                      borderRadius: "4px 4px 0 0",
                      minHeight: 2,
                    }}
                  />
                  <div style={{ fontSize: 8, color: "var(--text-soft, #9ca3af)", marginTop: 2 }}>
                    {b.bucket}
                  </div>
                </div>
              );
            ...
            <tbody>
              {data.cohorts.map((c: any) => (
                <tr key={c.cohort}>
                  ...
                  <td style={{ textAlign: "center", color: "#006233", fontWeight: 600 }}>
                    {c.approved}
                  </td>
                  <td style={{ textAlign: "center", color: "#b42318", fontWeight: 600 }}>
                    {c.rejected}
                  </td>
                  ...
                  <td style={{ textAlign: "center" }}>
                    <span
                      style={{
                        ...
                        fontWeight: 700,
                        background:
                          c.conversion_rate >= 70
                            ? "#dcfce7"
                            : c.conversion_rate >= 40
                              ? "#fef3c7"
                              : "#fef2f2",
                        color:
                          c.conversion_rate >= 70
