...
const selectStyle = { padding: "0.4rem 0.6rem", borderRadius: "6px", border: "1px solid #d1d5db", fontSize: "0.8rem", background: "#fff", cursor: "pointer", minWidth: "140px" };

export function OperateursFiltersClient({ secteur, province }: { secteur: string; province: string }) {
