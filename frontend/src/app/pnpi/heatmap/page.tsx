          ...
          return (
            ...
            >
              ...
              <div style={{ display: "flex", gap: 12, fontSize: 12, marginBottom: 8 }}>
                <span><strong style={{ color: "#006233" }}>{prov.conforme}</strong> conformes</span>
                <span><strong style={{ color: "#b42318" }}>{prov.non_conforme}</strong> non-conf.</span>
                <span><strong style={{ color: "#d97706" }}>{prov.partiel}</strong> partiels</span>
              </div>
              ...
              <div style={{ display: "flex", height: 8, borderRadius: 4, overflow: "hidden", background: "#e5e7eb" }}>
                {prov.total > 0 && (
                  <>
                    <div style={{ width: `${(prov.conforme / prov.total) * 100}%`, background: "#006233" }} />
                    <div style={{ width: `${(prov.partiel / prov.total) * 100}%`, background: "#d97706" }} />
                    <div style={{ width: `${(prov.non_conforme / prov.total) * 100}%`, background: "#b42318" }} />
                  </>
                )}
              </div>
