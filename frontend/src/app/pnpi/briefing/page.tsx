...
export default async function PNPIBriefingPage() {
  ...
  return (
    <section className="section briefing-shell">
      {/* Banner */}
      <div
        className="ministerial-banner chart-card"
        style={{
          background: "linear-gradient(135deg, #001f5c 0%, #003F8F 60%, #005f6b 100%)",
          color: "white",
          border: "none",
        }}
      >
        <div>
          ...
          >
            ...
            <div>
              ...
              >
                Republique Gabonaise &bull; Ministere de l&apos;Industrie
              </p>
              <h1 style={{ margin: 0, color: "white", fontSize: "1.4rem", fontWeight: 800 }}>
                Briefing Ministeriel PNPI
              </h1>
            </div>
          </div>
          <p style={{ margin: 0, color: "rgba(255,255,255,0.75)", fontSize: "0.875rem" }}>
            Plateforme Nationale de Pilotage Industriel &mdash; Synthese executive de la gestion des
            ATI
          </p>
        </div>
      ...
      >
        {[
          {
            label: "ATIs en cours de traitement",
            value: kpis.atis_en_cours,
            color: "#3b82f6",
            detail: `sur ${kpis.atis_total} au total`,
          },
          {
            label: "Délai moyen de traitement",
            value: `${kpis.delai_moyen_jours.toFixed(1)} j`,
            color: kpis.delai_moyen_jours <= 30 ? "#10b981" : "#f59e0b",
            detail: "Objectif : 30 jours",
          },
          {
            label: "Taux de conformite SLA",
            value: `${kpis.taux_sla_pct.toFixed(0)} %`,
            color: kpis.taux_sla_pct >= 80 ? "#10b981" : "#ef4444",
            detail:
              kpis.atis_en_retard > 0 ? `${kpis.atis_en_retard} en retard` : "Dans les delais",
          },
          {
            label: "Operateurs industriels actifs",
            value: kpis.operateurs_actifs,
            color: "#009440",
            detail: `${totalEmplois.toLocaleString("fr-FR")} emplois declares`,
          },
          {
            label: "ATIs approuves ce mois",
            value: kpis.atis_approuves_ce_mois,
            color: "#10b981",
            detail: "Agrements delivres",
          },
          {
            label: "Taux de conformite inspections",
            value: `${kpis.taux_conformite_pct.toFixed(0)} %`,
            color: "#7c3aed",
            detail: "Derniere periode",
          },
      ...
      <div className="chart-card" style={{ padding: "1.25rem", marginBottom: "1.25rem" }}>
        <h2 style={{ margin: "0 0 1rem", color: "#003F8F", fontSize: "1.05rem" }}>
          Pipeline de traitement des ATI
        </h2>
      ...
      >
        ...
        <div className="chart-card" style={{ padding: "1.25rem" }}>
          <h2 style={{ margin: "0 0 0.875rem", color: "#003F8F", fontSize: "1rem" }}>
            Activite par secteur industriel
          </h2>
          {topSecteur && (
            <div
              style={{
            ...
            >
              <strong>Secteur dominant :</strong> {topSecteur.secteur} · {topSecteur.nb_atis_total}{" "}
              ATIs, {topSecteur.nb_operateurs} operateurs
            </div>
          )}
                ...
                <tr key={s.secteur} style={{ borderBottom: "1px solid #f9fafb" }}>
                  ...
                  <td style={{ padding: "0.5rem" }}>
                    ...
                    <span style={{ color: "#6b7280", fontSize: "0.72rem" }}>
                      {" "}
                      ({s.taux_approbation_pct.toFixed(0)}%)
                    </span>
                  </td>
        ...
        <div className="chart-card" style={{ padding: "1.25rem" }}>
          ...
          {topProvince && (
            ...
            >
              <strong>Province la plus active :</strong> {topProvince.province.replace(/_/g, " ")} ·{" "}
              {topProvince.nb_atis_actifs} ATIs actifs
            </div>
          )}
          <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            {provinces.map((p) => {
              ...
              return (
                ...
                >
                  <div
                    style={{ fontSize: "0.8rem", color: "#374151", textTransform: "capitalize" }}
                  >
      ...
      {/* Tendance mensuelle */}
      <div
        className="chart-card print-break"
        style={{ padding: "1.25rem", marginBottom: "1.25rem" }}
      >
        <h2 style={{ margin: "0 0 0.75rem", color: "#003F8F", fontSize: "1rem" }}>
          Tendance mensuelle des agréments
        </h2>
        {trendDelta !== 0 && (
          <div
            style={{
              padding: "0.5rem 0.875rem",
              background: trendDelta > 0 ? "#f0fdf4" : "#fef2f2",
              borderRadius: "6px",
              marginBottom: "0.875rem",
              fontSize: "0.82rem",
              color: trendDelta > 0 ? "#166534" : "#b42318",
            }}
          >
            {trendDelta > 0
              ? `↑ Hausse de +${trendDelta} dossiers soumis sur le dernier mois`
              : `↓ Baisse de ${trendDelta} dossiers soumis sur le dernier mois`}
          </div>
        )}
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.8rem" }}>
          <thead>
              ...
              .map((t) => {
                ...
                return (
                  <tr key={t.mois} style={{ borderBottom: "1px solid #f9fafb" }}>
                    ...
                    <td style={{ padding: "0.5rem 0.75rem", color: "#10b981", fontWeight: 600 }}>
                      {t.nb_approuves}
                    </td>
                    ...
                    <td style={{ padding: "0.5rem 0.75rem" }}>
                      <span
                        style={{
                          ...
                          borderRadius: "4px",
                          background: parseInt(taux) >= 70 ? "#f0fdf4" : "#fef9eb",
                          color: parseInt(taux) >= 70 ? "#10b981" : "#d97706",
                          fontWeight: 700,
                          fontSize: "0.72rem",
                        }}
                      >
            ...
            {recents.slice(0, 15).map((ati) => (
              <tr
                ...
                style={{
                  ...
                  background: ati.is_overdue ? "#fef9eb" : "transparent",
                }}
              >
                <td
                  style={{
                ...
                <td
                  style={{
                    padding: "0.5rem 0.6rem",
                    color: ati.priorite === "urgente" ? "#ef4444" : "#6b7280",
      ...
      >
        <strong style={{ color: "#003F8F" }}>
          PNPI · Plateforme Nationale de Pilotage Industriel
        </strong>
        <br />
        Ministere de l&apos;Industrie de la Republique Gabonaise &middot; Document confidentiel
        &middot; {today}
      </div>
    </section>
  );
