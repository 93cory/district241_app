  ...
  const sections = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/pnpi/modele-metier", label: "Modele metier PNPI" },
        { href: "/pnpi/rin", label: "RIN national" },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/pnpi/oni", label: "Observatoire ONI" },
        { href: "/pnpi/filieres", label: "Filieres & chaines de valeur" },
        { href: "/pnpi/innovation", label: "Innovation 4.0" },
        { href: "/pnpi/capital-humain", label: "Capital humain industriel" },
        { href: "/pnpi/investissements", label: "Investissements industriels" },
        { href: "/pnpi/zones-industrielles", label: "Zones industrielles" },
        { href: "/pnpi/documents", label: "Coffre documentaire" },
        { href: "/pnpi/exploitation", label: "Exploitation PNPI" },
        { href: "/pnpi/interoperabilite", label: "Interopérabilité nationale" },
        { href: "/pnpi/geographie", label: "SIG national" },
        { href: "/pnpi/analytique", label: "BI & IA" },
        { href: "/pnpi/portail", label: "Portail & UX" },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/pnpi/durabilite", label: "Durabilite industrielle" },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/pnpi/securite", label: "Securite SOC PNPI" },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/pnpi/presentation", label: "Présentation PNPI" },
        { href: "/pnpi/dashboard-config", label: "Config dashboard" },
        { href: "/pnpi/heatmap", label: "Heatmap" },
        { href: "/pnpi/data-quality", label: "Qualité & gouvernance des données" },
