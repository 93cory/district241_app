...
export default function NewsletterPage() {
  ...
  const send = async () => {
    if (!subject || !body) {
      showToast("Sujet et contenu requis", "warning");
      return;
    }
    setSending(true);
    // Simulate sending
  ...
  const templates = [
    ...
    },
    {
      ...
      subject: "PNPI · Nouvelle fonctionnalite disponible",
