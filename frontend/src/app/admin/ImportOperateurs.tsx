  ...
  return (
    <div className="chart-card" style={{ padding: 20, marginBottom: "1rem" }}>
      ...
      <p style={{ margin: "0 0 14px", fontSize: 13, color: "var(--text-soft, #526175)" }}>
        Colonnes requises : <code>raison_sociale</code>, <code>nif_gabon</code>, <code>secteur</code>, <code>province</code>.
        Optionnelles : <code>ville</code>, <code>email</code>, <code>telephone</code>. Separateur : point-virgule.
      </p>
      ...
      {result && (
        <div style={{
          ...
          <div><strong>{result.created}</strong> operateur(s) crees</div>
          <div><strong>{result.skipped}</strong> ignore(s) (doublons ou incomplets)</div>
