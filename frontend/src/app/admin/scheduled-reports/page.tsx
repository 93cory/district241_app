...
export default function ScheduledReportsPage() {
  ...
  const create = async () => {
    ...
    if (res.ok) {
      showToast("Planification creee", "success");
      load();
          ...
          >
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 11, color: "var(--text-soft)" }}>
                {FREQ_LABELS[s.frequency]} &mdash; {s.format.toUpperCase()} &mdash; par{" "}
                {s.created_by}
              </div>
            ...
            <button
              ...
              style={{
                ...
                color: s.is_active ? "#006233" : "#526175",
                cursor: "pointer",
              }}
            >
