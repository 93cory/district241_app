        ...
        {[
          {
            ...
            value: data.total_requests.toLocaleString("fr-FR"),
            color: "#051B36",
          },
          { label: "Erreurs", value: data.total_errors, color: "#b42318" },
          {
            ...
            color: data.error_rate > 5 ? "#b42318" : "#006233",
          },
              ...
              {(data.endpoints || []).map((ep: EndpointStat) => {
                ...
                return (
                  <tr key={ep.endpoint}>
                    ...
                    <td style={{ textAlign: "center" }}>
                      <span
                        style={{
                          fontWeight: 700,
                          color:
                            ep.avg_ms > 500 ? "#b42318" : ep.avg_ms > 200 ? "#d97706" : "#006233",
                        }}
                      >
                        {ep.avg_ms}ms
                      </span>
                    ...
                    <td style={{ width: 120 }}>
                      <div
                        style={{ height: 6, borderRadius: 3, background: "var(--line, #e5e7eb)" }}
                      >
                        <div
                          style={{
                            height: "100%",
