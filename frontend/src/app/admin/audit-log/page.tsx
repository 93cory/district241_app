...
export default function AuditLogPage() {
  ...
  const exportCsv = () => {
    ...
    const rows = events.map((e) =>
      [new Date(e.created_at).toLocaleString("fr-FR"), e.actor, e.action, e.target, e.details].join(
        ";",
      ),
    );
            ...
            <tbody>
              ...
              {events.length === 0 && (
                <tr>
                  <td
                    colSpan={5}
                    style={{ textAlign: "center", padding: 24, color: "var(--text-soft, #526175)" }}
                  >
                    Aucun evenement
                  </td>
                </tr>
