...
export default async function EmbedStatusPage() {
  ...
  const colors: Record<string, string> = { operational: "#006233", degraded: "#d97706", down: "#b42318" };
  const labels: Record<string, string> = { operational: "Operationnel", degraded: "Degrade", down: "Indisponible" };
