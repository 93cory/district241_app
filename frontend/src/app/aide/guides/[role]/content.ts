...
const COMMON_SECURITY: Section = {
  ...
  blocks: [
    { kind: "p", text: "Votre compte donne accès à des données sensibles. Quelques règles simples protègent vous et la plateforme." },
    ...
    { kind: "p", text: "Activez le second facteur depuis votre profil. À chaque connexion, l'application demandera un code à 6 chiffres généré par votre application d'authentification (Google Authenticator, Authy, Aegis...)." },
    ...
    { kind: "warn", text: "En cas de perte d'appareil ou de soupçon de compromission, contactez l'administrateur sans délai pour révoquer votre session." },
  ],
};
...
const COMMON_SUPPORT: Section = {
  ...
  blocks: [
    { kind: "p", text: "L'assistant intégré (icône en bas à droite de chaque page) répond aux questions les plus fréquentes en s'appuyant sur la documentation officielle." },
    { kind: "p", text: "Pour un signalement technique, utilisez la page « Aide » ou contactez l'administrateur de la plateforme." },
    { kind: "note", text: "Tous les écrans disposent d'une icône de tour guidé qui vous explique les fonctionnalités principales en moins de deux minutes." },
  ],
};
...
export const GUIDES: Record<RoleSlug, Guide> = {
  admin: {
    ...
    intro: "L'administrateur garantit la fiabilité technique et organisationnelle de la PNPI : comptes, sauvegardes, audit, intégrations.",
    sections: [
      {
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "p", text: "Menu Admin → Utilisateurs → « Nouveau ». Renseignez identifiant, nom complet, rôles. Un mot de passe initial est généré : il devra être changé à la première connexion." },
          { kind: "h3", text: "Suspendre un compte" },
          { kind: "p", text: "Désactivez l'utilisateur (is_active=false) plutôt que de le supprimer : cela préserve l'historique audit." },
          { kind: "warn", text: "Une suppression définitive d'utilisateur conserve les actes administratifs qu'il a signés (intégrité juridique)." },
        ],
      },
      {
        title: "Sauvegardes et restauration",
        blocks: [
          { kind: "p", text: "La plateforme dispose d'un script automatisé qui exporte chaque nuit la base PostgreSQL vers S3/MinIO." },
          { kind: "ul", items: [
          ...
          { kind: "note", text: "Une notification d'échec de sauvegarde déclenche une alerte e-mail et Slack." },
        ],
      },
      {
        title: "Journal d'audit",
        blocks: [
          { kind: "p", text: "Menu Admin → Audit. Filtres disponibles : utilisateur, type d'événement, plage de dates, ATI ciblé." },
          { kind: "p", text: "Exportez les événements en CSV pour analyse externe ou conservation longue durée." },
        ],
      },
      COMMON_SECURITY,
      COMMON_SUPPORT,
  ...
  ministre: {
    ...
    roleLabel: "Ministre",
    intro: "Vue stratégique sur l'industrie nationale : décisions ministérielles, synthèses exécutives, tendances et projections.",
    sections: [
      {
        title: "Votre tableau de bord",
        blocks: [
          { kind: "p", text: "À la connexion, vous accédez directement au tableau de bord ministériel : volumes par secteur et province, dépassements SLA, scoring des opérateurs, projections IA." },
          { kind: "ul", items: [
      ...
      },
      {
        ...
        blocks: [
          { kind: "p", text: "Les ATI parvenus au stade de validation finale apparaissent dans votre file « En attente de décision »." },
          ...
          { kind: "p", text: "Le rejet exige une motivation formelle. L'opérateur peut resoumettre après corrections." },
          { kind: "warn", text: "Toutes vos décisions sont horodatées, signées et archivées. Elles sont opposables et auditables sans limite de temps." },
        ],
      },
      {
        title: "Synthèses et exports",
        blocks: [
          { kind: "p", text: "Génération à la demande de rapports exécutifs PDF, présentations PowerPoint pour conseil des ministres, exports Excel pour analyses externes." },
          { kind: "p", text: "Rapports hebdomadaires automatiques envoyés tous les lundis à 06h00 (Cabinet et directeurs)." },
        ],
      },
      COMMON_SECURITY,
      COMMON_SUPPORT,
  ...
  directeur: {
    ...
    roleLabel: "Directeur",
    intro: "Le Directeur coordonne l'équipe d'instructeurs, valide en intermédiaire et pilote la performance opérationnelle.",
    sections: [
      {
      ...
      },
      {
        title: "Workflow ATI",
        blocks: [
          { kind: "p", text: "Vous intervenez à l'étape de validation intermédiaire entre l'instructeur et le Ministre." },
          ...
          { kind: "p", text: "En cas de pièce manquante ou d'incohérence, renvoyez le dossier à l'instructeur avec une note explicative. Le délai SLA est mis en pause." },
        ],
      },
      {
  ...
  instructeur: {
    ...
    intro: "Cœur du métier : vous recevez les dossiers, vérifiez les pièces, demandez les compléments et faites avancer les ATI dans le workflow.",
    sections: [
      {
        title: "Votre file de travail",
        blocks: [
          { kind: "p", text: "Onglet « Mes dossiers » : tous les ATI qui vous sont assignés, triés par échéance SLA." },
          { kind: "ul", items: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "p", text: "Ouvrez le dossier, consultez les pièces jointes (statuts, bilan, plan de site, certifications)." },
          ...
          { kind: "p", text: "Si une pièce manque, utilisez le bouton « Demander un complément » : un message est envoyé à l'opérateur avec votre note. Le SLA est suspendu jusqu'à réception." },
          { kind: "h3", text: "4. Transmission" },
          { kind: "p", text: "Une fois l'instruction terminée, transmettez au Directeur avec votre avis (favorable / défavorable / réservé) et une note de synthèse." },
        ],
      },
      {
        title: "Outils utiles",
        blocks: [
          ...
          { kind: "note", text: "L'assistant IA peut pré-remplir certains champs à partir des documents joints (OCR à venir)." },
        ],
      },
      COMMON_SECURITY,
      COMMON_SUPPORT,
  ...
  inspecteur: {
    ...
    intro: "Sur le terrain, vous réalisez les inspections de conformité avec preuves photographiques géolocalisées et rapports détaillés.",
    sections: [
      {
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "p", text: "Vous pouvez saisir entièrement votre rapport sans connexion. La synchronisation s'effectue dès que le réseau revient." },
          { kind: "warn", text: "Sécurisez vos photos avec géolocalisation activée : elles servent de preuves en cas de contestation." },
        ],
      },
      {
  ...
  operateur: {
    ...
    intro: "Soumettez vos demandes d'agrément, suivez vos dossiers, téléchargez vos certificats — votre guichet personnel ouvert 24/7.",
    sections: [
      {
        title: "Premiers pas",
        blocks: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "p", text: "Vérifiez la complétude puis cliquez sur « Soumettre ». Vous recevez un accusé de réception immédiat avec un numéro de dossier unique." },
        ],
      },
      {
        title: "Suivi de vos dossiers",
        blocks: [
          { kind: "p", text: "Le statut de chaque dossier évolue selon le workflow : Soumis → En instruction → Validé en intermédiaire → Décidé (Approuvé ou Rejeté)." },
          { kind: "ul", items: [
          ...
          { kind: "note", text: "Le délai légal de traitement est de 45 jours. La PNPI vous alerte si une dérive est constatée." },
        ],
      },
      {
        title: "Certificat et renouvellement",
        blocks: [
          { kind: "p", text: "Une fois l'ATI approuvé, téléchargez le certificat PDF officiel. Il contient un QR code permettant à toute personne (douanes, banques, partenaires) de vérifier son authenticité en ligne." },
          { kind: "p", text: "L'ATI est valable un nombre d'années défini selon le secteur. Vous recevez des rappels automatiques 90, 60 et 30 jours avant expiration pour engager le renouvellement." },
        ],
      },
      COMMON_SECURITY,
      COMMON_SUPPORT,
