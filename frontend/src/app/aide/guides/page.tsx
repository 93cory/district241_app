...
const ROLES: { slug: string; label: string; tagline: string; color: string }[] = [
  {
    ...
    tagline: "Supervision technique et organisationnelle",
    color: "#b42318",
  },
  {
    slug: "ministre",
    label: "Ministre",
    tagline: "Décision stratégique et pilotage politique",
    color: "#051B36",
  },
  {
    slug: "directeur",
    label: "Directeur",
    tagline: "Pilotage opérationnel et validation intermédiaire",
    color: "#009E60",
  },
  {
    slug: "instructeur",
    label: "Instructeur",
    tagline: "Instruction des dossiers ATI",
    color: "#003DA5",
  },
  {
    slug: "inspecteur",
    label: "Inspecteur",
    tagline: "Inspections de conformité terrain",
    color: "#7c3aed",
  },
  {
    slug: "operateur",
    label: "Opérateur",
    tagline: "Guichet entreprise · soumission et suivi",
    color: "#d97706",
  },
];
...
export default function GuidesIndexPage() {
  return (
    ...
    >
      ...
      <p
        style={{ fontSize: 15, color: "#526175", marginBottom: 32, maxWidth: 640, lineHeight: 1.6 }}
      >
      ...
      >
        {ROLES.map((r) => (
          ...
          >
            ...
            <div style={{ fontSize: 13, color: "#526175", lineHeight: 1.5 }}>{r.tagline}</div>
