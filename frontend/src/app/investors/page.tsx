    ...
    <div style={{ minHeight: "100vh", fontFamily: "Manrope, system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 900, margin: "-30px auto 40px", padding: "0 24px" }}>
        ...
        >
          {[
            {
              label: "Operateurs actifs",
              value: s.operateurs_actifs || kpis.operateurs_actifs || 0,
              icon: "\ud83c\udfed",
            },
            {
              label: "Agrements delivres",
              value: s.atis_approuves || kpis.atis_approuves || 0,
              icon: "\ud83d\udccb",
            },
            {
              label: "Emplois estimes",
              value: (s.emplois_estimes || 0).toLocaleString("fr-FR"),
              icon: "\ud83d\udc77",
            },
            {
              label: "Investissement",
              value: `${((s.investissement_mfcfa || 0) / 1000).toFixed(1)} Mds FCFA`,
              icon: "\ud83d\udcb0",
            },
          ].map((k) => (
            <div
            ...
            >
              ...
              <div style={{ fontSize: 24, fontWeight: 800, color: "#006233", marginTop: 4 }}>
                {k.value}
              </div>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto 40px", padding: "0 24px" }}>
        ...
        >
          {[
            {
              name: "Bois & Forets",
              desc: "Scieries, contreplaque, transformation secondaire. Le Gabon possede 22 millions d'hectares de forets.",
              icon: "\ud83c\udf32",
            },
            {
              name: "Mines",
              desc: "Manganese (2e producteur mondial), or, fer. Potentiel d'enrichissement local considerable.",
              icon: "\u26cf\ufe0f",
            },
            {
              name: "Agroalimentaire",
              desc: "Huile de palme, cacao, cafe, hevea. Objectif de souverainete alimentaire.",
              icon: "\ud83c\udf3e",
            },
            {
              name: "Energie",
              desc: "Hydroelectricite, solaire, gaz naturel. Objectif 100% energies renouvelables.",
              icon: "\u26a1",
            },
            {
              name: "Peche",
              desc: "Zone maritime riche. Conserveries de thon, crevettes, transformation des produits halieutiques.",
              icon: "\ud83d\udc1f",
            },
            {
              name: "BTP & Construction",
              desc: "Ciment, granulats, prefabrication. Marche en forte croissance avec l'urbanisation.",
              icon: "\ud83c\udfd7\ufe0f",
            },
          ].map((s) => (
            <div
            ...
            >
              ...
              <div style={{ fontSize: 16, fontWeight: 700, marginBottom: 4, color: "#051B36" }}>
                {s.name}
              </div>
            ...
            {[
              {
                step: "1",
                title: "Inscription",
                desc: "Creez votre compte operateur sur la plateforme PNPI.",
              },
              {
                step: "2",
                title: "Soumission",
                desc: "Deposez votre dossier ATI avec les documents requis.",
              },
              {
                step: "3",
                title: "Instruction",
                desc: "Nos instructeurs analysent votre dossier sous 45 jours.",
              },
              {
                step: "4",
                title: "Decision",
                desc: "Recevez votre agrement et votre certificat avec QR code.",
              },
            ].map((s) => (
              <div
                key={s.step}
      ...
      <div style={{ textAlign: "center", padding: "50px 24px" }}>
        ...
        <p style={{ fontSize: 14, color: "#526175", marginBottom: 20 }}>
          Contactez le Ministere de l&apos;Industrie ou inscrivez-vous directement sur la
          plateforme.
        </p>
        <a
          href="/connexion"
      ...
      >
        Ministere de l&apos;Industrie et de la Transformation Locale · Republique Gabonaise · PNPI{" "}
