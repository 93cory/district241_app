...
const markRead = async (id: string) => {
  try {
    ...
    /* non-critical: notifications unavailable */
  }
};
        ...
        >
          ...
          >
            <span style={{ fontWeight: 700, fontSize: "0.875rem", color: "#1f2937" }}>
              Notifications{" "}
              {unread > 0 && <span style={{ color: "#ef4444" }}>({unread} non lues)</span>}
            </span>
            {notifs.length === 0 && (
              <span style={{ fontSize: "0.75rem", color: "#6b7280" }}>Aucune</span>
            )}
          </div>
          {notifs.length === 0 ? (
            <div
              ...
              {notifs.slice(0, 10).map((n) => (
                ...
                >
                    ...
                    >
                      ...
                      <span
                        style={{
                          fontSize: "0.68rem",
                          fontWeight: 700,
                          color: SEV_COLORS[n.severity] ?? "#6b7280",
                  ...
                  <div style={{ marginTop: "0.25rem", fontSize: "0.7rem", color: "#6b7280" }}>
                    ...
                    {!n.is_read && (
                      <span style={{ color: "#3b82f6", marginLeft: "0.4rem" }}>
