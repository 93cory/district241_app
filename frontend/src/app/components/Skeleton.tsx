export function SkeletonBox({ width, height, radius = 8 }: { width?: string | number; height?: string | number; radius?: number }) {
  return (
    <div
      style={{
        width: width ?? "100%",
...
export function SkeletonDashboard() {
  return (
    <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      {[1, 2, 3].map((i) => (
        <div key={i} style={{ display: "flex", gap: 12, alignItems: "center", padding: 14, background: "#fff", borderRadius: 12 }}>
