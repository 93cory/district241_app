        ...
        {Array.from({ length: rows }).map((_, i) => (
          <div key={i} className="skeleton-card" aria-hidden="true">
            <div
              ...
              style={{ height: "1.2rem", width: "60%", marginBottom: "0.75rem" }}
            />
            <div className="skeleton-line" style={{ height: "0.9rem", width: "80%" }} />
            <div
              className="skeleton-line"
              style={{ height: "0.9rem", width: "45%", marginTop: "0.5rem" }}
            />
          </div>
        ))}
      </div>
    ...
    <div aria-hidden="true" role="status" aria-label="Chargement en cours">
      {Array.from({ length: rows }).map((_, i) => (
        ...
        >
          <div
            className="skeleton-line"
            style={{ height: "1rem", width: "15%", minWidth: "60px" }}
          />
          <div
            className="skeleton-line"
            style={{ height: "1rem", width: "35%", minWidth: "120px" }}
          />
          <div
            className="skeleton-line"
            style={{ height: "1rem", width: "20%", minWidth: "80px" }}
          />
          <div
            className="skeleton-line"
            style={{ height: "1rem", width: "12%", minWidth: "50px" }}
          />
        </div>
      ))}
    </div>
