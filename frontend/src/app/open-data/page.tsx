...
export default async function OpenDataPage() {
  ...
  const datasets = [
    {
      name: "Operateurs industriels actifs",
      format: "GeoJSON",
      endpoint: "/geo/export.geojson",
      desc: "Liste georeferencee de tous les operateurs avec secteur et province.",
      auth: "JWT",
    },
    {
      name: "ATIs approuves (Excel)",
      format: "XLSX",
      endpoint: "/exports/atis.xlsx?statut=approuve",
      desc: "Registre des agrements techniques approuves.",
      auth: "JWT",
    },
    {
      name: "Operateurs (Excel)",
      format: "XLSX",
      endpoint: "/exports/operateurs.xlsx",
      desc: "Annuaire complet des operateurs industriels.",
      auth: "JWT",
    },
    {
      name: "Statistiques KPIs",
      format: "JSON",
      endpoint: "/pnpi/dashboard/kpis",
      desc: "Indicateurs cles en temps reel.",
      auth: "JWT",
    },
    {
      name: "Verification ATI",
      format: "JSON",
      endpoint: "/pnpi/ati/verify/{numero}",
      desc: "Verification publique d'un agrement par numero.",
      auth: "Public",
    },
    {
      name: "Statut systeme",
      ...
      desc: "Etat operationnel de la plateforme.",
      auth: "Public",
    },
    {
      name: "Archive annuelle",
      format: "JSON",
      endpoint: "/exports/create-archive",
      desc: "Archive scellee avec hash d'integrite SHA-256.",
      auth: "Admin",
    },
  ];
  ...
  return (
    <div style={{ minHeight: "100vh", fontFamily: "Manrope, system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 900, margin: "-20px auto 40px", padding: "0 24px" }}>
            ...
            >
              ...
              <span
                style={{
                  ...
                  fontWeight: 700,
                  background:
                    ds.auth === "Public" ? "#dcfce7" : ds.auth === "Admin" ? "#fef2f2" : "#e0f2fe",
                  color:
                    ds.auth === "Public" ? "#006233" : ds.auth === "Admin" ? "#b42318" : "#0c7eb4",
                }}
              >
                {ds.auth}
              </span>
        ...
        >
          <strong>Licence :</strong> Les donnees publiques de la PNPI sont disponibles sous licence{" "}
          <strong>Open Data Gabon</strong>. Les donnees personnelles et sensibles sont protegees
          conformement a la reglementation en vigueur.
          <br />
          <br />
          <strong>API :</strong> Documentation technique disponible a{" "}
          <a href="/api-docs" style={{ color: "#006233", fontWeight: 600 }}>
            /api-docs
          </a>
          . API GraphQL disponible a{" "}
