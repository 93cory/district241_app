    ...
    <div style={{ padding: "24px 32px", maxWidth: 1000, margin: "0 auto" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
          {[
            ...
            {
              label: "Non conformes",
              value: kpis.inspections_non_conformes || 0,
              color: "#b42318",
            },
      ...
      <div className="chart-card" style={{ padding: 20 }}>
        ...
        {recentInspections.length === 0 ? (
          <p style={{ color: "var(--text-soft, #526175)", fontSize: 13 }}>
            Aucune inspection recente.
          </p>
        ) : (
                  ...
                  return (
                    <tr key={insp.id}>
                      ...
                      <td style={{ fontWeight: 600 }}>
                        {insp.operateur_nom || insp.operateur_id?.slice(0, 8)}
                      </td>
                      <td>
                        <span
                          style={{
                      ...
                      <td>
                        <a
                          ...
                          style={{ fontSize: 12, color: "#0c7eb4", fontWeight: 600 }}
                        >
                          Detail
                        </a>
                      </td>
