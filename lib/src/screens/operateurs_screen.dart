...
class _OperateursScreenState extends State<OperateursScreen> {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: FilledButton.icon(
              ...
              label: const Text('Enregistrer un opérateur'),
              style: FilledButton.styleFrom(
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: 'Rechercher opérateur, NIF, ville…',
              filled: true,
  ...
  Widget _buildCard(OperateurIndustriel op) {
    final conformiteColor = _conformiteColor(op.statutConformite);
    final secteurColor = _secteurColor(op.secteur);

    return GestureDetector(
      onTap: () => _showDetail(op),
      child: Container(
